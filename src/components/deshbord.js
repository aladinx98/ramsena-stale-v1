...
const Deshbord = () => {
  ...
  const { contract } = useContract(
    "0x85C2509d73FCbd3edd7e40F07Ae9E0000beC164e"
  );
  ...
  const approveTokens = async () => {
    try {
      ...
      let spender = "0x85C2509d73FCbd3edd7e40F07Ae9E0000beC164e"; //contract address
  ...
  const WithdrawCheck = async () => {
    ...
    for (let i = 0; i < len; i++) {
      promises.push(
        sdk
          .getContract("0x85C2509d73FCbd3edd7e40F07Ae9E0000beC164e")
          .then((contract1) =>
